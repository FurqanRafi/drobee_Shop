...
const Checkout = () => {
  ...
  const productPrice = 145.5;
  const subtotal = 145.5;
  const total = 145.5;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="lg:hidden">
              <button className="w-full py-4 bg-gray-900 text-white font-bold rounded-lg hover:bg-black transition-all flex items-center justify-center gap-3 text-base">
                <Lock size={18} />
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-lg shadow-sm p-6 lg:sticky lg:top-6">
              ...
              {/* Customize Button */}
              <button className="mt-4 text-sm text-gray-600 hover:text-gray-900 transition-colors flex items-center gap-2 mx-auto">
