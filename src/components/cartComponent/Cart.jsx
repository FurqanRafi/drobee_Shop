    ...
    <div className="min-h-screen  px-4 py-6 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="hidden lg:block bg-white border border-black/10 rounded-lg shadow-sm mb-6 overflow-hidden">
          ...
          {/* Product Row */}
          <div className="grid grid-cols-12 gap-4 px-6 py-6 items-center border-b border-gray-100">
        ...
        <div className="lg:hidden bg-white rounded-lg shadow-sm mb-6 overflow-hidden">
          <div className="p-4 sm:p-6">
            ...
            <div className="relative">
              <button className="absolute top-0 right-0 text-gray-400 hover:text-red-500 transition-colors z-10">
                <X size={24} />
              </button>
